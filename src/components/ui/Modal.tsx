...
export const Modal = () => {
  return (
    <div
      ...
      className="inset-0 z-[999] grid h-screen place-items-center duration-300 absolute border-x-black"
    >
      <div
        data-dialog="modal"
        className="absolute m-4 p-4 w-2/5 min-w-[40%] max-w-[40%] rounded-lg bg-white shadow-sm "
      >
